...
import type { LoadRunParams } from "@/features/ergo/thanos_sort/lib/types";
...
export interface ControlPanelProps {
  ...
  onShowCrosshairChange: (v: boolean) => void;
  onStart: () => void;
  onTogglePlay: () => void;
  onStep: () => void;
  onReset: () => void;
    ...
    <div className="sticky top-0 z-10 flex flex-col gap-4 border-b border-border bg-background/90 px-4 py-4 backdrop-blur md:px-6">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="ml-auto flex items-center gap-2">
          <Label htmlFor="crosshair" className="text-muted-foreground">
            十字线
          </Label>
          <Switch
            id="crosshair"
